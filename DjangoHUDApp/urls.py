...
urlpatterns = [
    ...
    path('add-transaction/', views.add_transaction, name='addTransactions'),
    path('all-transactions/', views.transactions, name='transactions'),
    path('leaderboard/', views.leaderboard, name='leaderboard'),
    path('login/', views.UserLoginView.as_view(), name='login'),
    path('logout/', views.UserLogoutView.as_view(next_page='DjangoHUDApp:login'), name='logout'),
